...
public class AuthControllerTest {
    ...
    public void userAlreadyExistTest() throws Exception {
        User user = new User();
        user.setName("Adnan");
        user.setEmail("adnankasmani1@gmail.com");
        user.setPassword("tempPassword");



        Mockito.when(userRepository.findOneByEmail("adnankasmani1@gmail.com")).thenReturn(user);
        setUp();
        String uri = "/auth/register";
  ...
  public void registerUserTest() throws Exception {
        ...
        Mockito.when(userRepository.findOneByEmail("adnankasmani1@gmail.com")).thenReturn(null);
        setUp();
        String uri = "/auth/register";
